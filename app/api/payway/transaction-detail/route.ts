// File: app/api/payway/transaction-detail/route.ts
...
const URL = `${BASE_URL}/transaction-detail`;
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("PayWay Transaction Detail Error:", error.response?.data || error.message);
    return NextResponse.json({ error: "Failed to fetch transaction details" }, { status: 502 });
  }
}
