...
export const AvailabilitySection: React.FC<AvailabilitySectionProps> = ({ postId }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-500">Select the dates you're available for this tour.</p>
      <Calendar
        mode="multiple"
      ...
      <div className="flex justify-end space-x-4">
        <Button onClick={() => router.push('/guide-dashboard')} variant="outline">
          Skip for Now
        </Button>
