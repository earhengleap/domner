    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-2 " action="#">
      ...
      <div>
        ...
        <input
          ...
          id="password"
          placeholder="••••••••"
          className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-lg rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          required
        />
        {errors.password && (
          <small className="text-red-600 text-sm ">
      ...
      <div className="">
        ...
        >
          <FaGoogle onClick={()=>signIn("google")} className="mr-2 text-red-600 w-4 h-4" />
          Sign in with Google
        </button>
        <button
